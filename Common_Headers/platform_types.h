...
#define UE_MODULE_ID_TO_INSTANCE( mODULE_iD ) mODULE_iD + 0
#define ENB_MODULE_ID_TO_INSTANCE( mODULE_iD ) mODULE_iD
#define UE_INSTANCE_TO_MODULE_ID( iNSTANCE ) iNSTANCE - 0
...
#define PROTOCOL_CTXT_FMT
//#define PROTOCOL_CTXT_ARGS(CTXT_Pp) "RLC"
